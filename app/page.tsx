...
export default function Home() {
  ...
  const cremaVariants = [
    { colorName: "Estilo 1", numberStyle: "1", imageSrc: "/images/crema1.png", sizes: imageSizes, loading: "eager" as const }, 
    { colorName: "Estilo 2", numberStyle: "2", imageSrc: "/images/crema2.png", sizes: imageSizes, loading: "lazy" as const }, 
    { colorName: "Estilo 3", numberStyle: "3", imageSrc: "/images/crema.png", sizes: imageSizes, loading: "lazy" as const },
    { colorName: "Estilo 4", numberStyle: "4", imageSrc: "/images/crema_4.png", sizes: imageSizes, loading: "lazy" as const },
    { colorName: "Estilo 5", numberStyle: "5", imageSrc: "/images/crema4.png", sizes: imageSizes, loading: "lazy" as const },
    { colorName: "Estilo 6", numberStyle: "6", imageSrc: "/images/crema6.png", sizes: imageSizes, loading: "lazy" as const },
  ];

  const labialesVariants = [
    { colorName: "Rojo Intenso", numberStyle: "1", imageSrc: "/images/labial_1.jpeg", sizes: imageSizes, loading: "eager" as const },
    { colorName: "Rosa Suave", numberStyle: "2", imageSrc: "/images/labial_2.jpeg", sizes: imageSizes, loading: "lazy" as const },
    { colorName: "Nude Elegante", numberStyle: "3", imageSrc: "/images/labial_3.jpeg", sizes: imageSizes, loading: "lazy" as const },
    { colorName: "Vino Profundo", numberStyle: "4", imageSrc: "/images/labial_4.jpeg", sizes: imageSizes, loading: "lazy" as const },
    { colorName: "Coral Vibrante", numberStyle: "5", imageSrc: "/images/labial_5.jpeg", sizes: imageSizes, loading: "lazy" as const },
    { colorName: "Fucsia Brillante", numberStyle: "6", imageSrc: "/images/labial_6.jpeg", sizes: imageSizes, loading: "lazy" as const },
  ];

  const accessoryVariants = [
    { colorName: "Accesorio 1", numberStyle: "1", imageSrc: "/images/accesorio1.png", sizes: imageSizes, loading: "eager" as const },
    { colorName: "Accesorio 2", numberStyle: "2", imageSrc: "/images/accesorio2.png", sizes: imageSizes, loading: "lazy" as const },
    { colorName: "Accesorio 3", numberStyle: "3", imageSrc: "/images/accesorio3.png", sizes: imageSizes, loading: "lazy" as const },
    { colorName: "Accesorio 4", numberStyle: "4", imageSrc: "/images/accesorio4.png", sizes: imageSizes, loading: "lazy" as const },
    { colorName: "Accesorio 5", numberStyle: "5", imageSrc: "/images/accesorio5.png", sizes: imageSizes, loading: "lazy" as const },
    { colorName: "Accesorio 6", numberStyle: "6", imageSrc: "/images/accesorio6.png", sizes: imageSizes, loading: "lazy" as const },
  ];
    ...
    <main className="min-h-screen bg-gradient-to-b from-white to-pink-50/40 py-10 px-4 sm:px-6 lg:px-8 font-sans flex flex-col items-center">
      ...
      <div className="w-full max-w-5xl">
        ...
        <div>
          ...
          <div className="flex flex-wrap justify-center sm:justify-start gap-5 mb-12">
            <CardItem 
